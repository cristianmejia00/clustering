...
`zz_utils/00_system_paths.R` resolves the cloud-storage root (`output_folder_path`) per OS (macOS, Windows, Linux). Update paths there if your mount point differs.
