...
bibliometrics_folder <- file.path(root_path, "Documentos", "03-bibliometrics")
...
write.csv(dataset, file = 'dataset_Q307_bio.csv', row.names = FALSE)
#################################################
# Save and FINISH!
#################################################
