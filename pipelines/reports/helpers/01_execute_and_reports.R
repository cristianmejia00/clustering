...
for (level_report_iteration in available_levels) {
  ...
  if (level_report_iteration == 0) {
    source("pipelines/dataset/utils/02_citation_network/04_data_scope_level0.R")
  }
  if (level_report_iteration == 1) {
    source("pipelines/dataset/utils/02_citation_network/04_data_scope_level1.R")
  }
  if (level_report_iteration == 2) {
    source("pipelines/dataset/utils/02_citation_network/04_data_scope_level2.R")
  }
  if (level_report_iteration == 3) {
    source("pipelines/dataset/utils/02_citation_network/04_data_scope_level3.R")
  }
