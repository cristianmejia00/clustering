...
# Save matrix
colnames(cluster_citation_out_prop_matrix) <- paste(colnames(cluster_citation_out_prop_matrix), "---", sep = "")
write.csv(cluster_citation_out_prop_matrix, file="subcluster_outcitations_prop_table.csv", row.names = FALSE)
getwd()
...
# Save matrix
colnames(cluster_citation_in_prop_matrix) <- paste(colnames(cluster_citation_in_prop_matrix), "---", sep = "")
write.csv(cluster_citation_in_prop_matrix, file="subcluster_incitations_prop_table.csv", row.names = FALSE)
getwd()
