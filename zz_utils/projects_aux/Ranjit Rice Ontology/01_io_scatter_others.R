...
# Cheat code
dff_filtered$mean_citations[dff_filtered$intervention_category == "Biochar and Pyrolytic Carbon Management" & dff_filtered$output_category == "Nitrogen Cycling and Loss Reduction"] <- 67
